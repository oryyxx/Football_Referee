...
def torch_thread(weights, img_size, conf_thres=0.2, iou_thres=0.45):
    global image_net, exit_signal, run_signal, detections, loading
...
def main():
    ...
    capture_thread = Thread(target=torch_thread,kwargs={'weights': model_yolo, 'img_size': image_size, "conf_thres": confident_threshold})
    ...
    while not exit_signal:
        ...
        foundBall = False #the model detects multiple balls from the same ball so i stopped detection for ball when one is found
